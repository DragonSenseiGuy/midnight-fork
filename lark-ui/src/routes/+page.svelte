...
<div class="bg-[#443B61] min-h-screen">
  <section
    class="bg-[#f24b4b] w-full flex flex-col items-center h-screen relative min-h-[700px] md:min-h-[800px] overflow-hidden"
  >
    <MidnightHeader />

    <div
      class="flex flex-col items-center justify-center flex-grow pt-16 px-4 pb-[120px] md:pb-[140px] lg:pb-[160px] 2xl:pb-[200px]"
    >
      <div class="flex flex-col items-center w-full max-w-7xl">
        <h1 class="sr-only">Midnight - A Murder Mystery by Hack Club</h1>

        <div
          class="relative w-full max-w-3xl 2xl:max-w-4xl px-4 -mb-4 md:-mb-6 2xl:-mb-6"
        >
          <img
            alt="Midnight - A Murder Mystery"
            class="w-full h-auto block"
            style="object-fit: contain; background-repeat: no-repeat; background-size: contain;"
            src="/logo.svg"
          />
        </div>
  ...
  >
    ...
    >
      <iframe
        width="560"
        height="315"
        src="https://www.youtube.com/embed/oKHU66Ar6Gk?si=9kKLARVPPCcyygt-"
  ...
  >
    ...
    >
      ...
      <div class="letter-content">
        ...
        <p>
          Every year, Hack Club does something special. We have organized a
          bunch of wild adventures in the past (Shipwrecked, Juice, the Hacker
          Zephyr, etc).
        </p>

        <p>
          This year Hack Club is organizing our first ever murder mystery themed
          flagship hackathon in the EU. We will be working together online for
          two months, making our own projects, shipping them, and then getting
          together in-person in Vienna, Austria to be a part of an in-person
          murder mystery themed hackathon.
        </p>

        <p>
          You will have a community of makers and hackers just like yourself who
          want to build projects they're proud of! Every week, the midnight team
          will run calls and Slack huddles, as well as special online events for
          you to meet other participants coming to Midnight.
        </p>

        <p>
          For some of you, this might be the first time you're building
          projects. Others might be more experienced! We built Midnight to
          support hackers from with all levels of experience.
        </p>
        ...
        <p>
          Being a part of events like these changed our lives as teenagers, and
          made us all fall in love with making things. All of us took our first
          solo flights to go to Hack Club events, build cool shit, and form some
          of our best friendships. We hope you get to experience that too :)
        </p>

        <p class="letter-signature">With love,</p>
        <p class="letter-signature">
          Alex, Kacper, Sebastian, Renran, Manitej, Dev and the Midnight Team
        </p>
